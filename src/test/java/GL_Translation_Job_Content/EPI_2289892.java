...
* Author        : Amrata M.
*
* Test case     : Verify whether custom content type Long String(>255) is supported for translation
* Precondition  : Create a Standard Page and put different types of content in Long String Field (Content like URL Text, URL Content, Test URL type etc)
* 
************************************************************************************************************************************************/

public class EPI_2289892 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_2289892_URLTesting";
	String SubName = "EpiServer_Sub_2289892";
	
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_2289892");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_2289892 : Verify whether custom content type Long String(>255) is supported for translation");
				dataSet.put("TL_internal_testCase_ID", "2289892");
	}	 
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				common.action().Create_StanderedPage("Admin", "Content Type","[Default] Standard Page", "Long string (>255)", "URL_Content", "URL TESTS");
				...
				//long string
				Verify.action().verifyElementPresent(locators.exts().CMS_edit_LongString,  5);
				BrowserFactory.SystemEngine().findElement(locators.exts().CMS_edit_LongString).sendKeys(Keys.CONTROL+"a");
				BrowserFactory.SystemEngine().findElement(locators.exts().CMS_edit_LongString).sendKeys(Keys.DELETE);
				BrowserFactory.SystemEngine().findElement(locators.exts().CMS_edit_LongString).sendKeys("This is URL Tests ");
				Thread.sleep(2000);
		...
		try{	
	    	...
	    	if(assertion == false){
				report("f"," assertion is failed while verifying URL Test");
	    	}
			else{

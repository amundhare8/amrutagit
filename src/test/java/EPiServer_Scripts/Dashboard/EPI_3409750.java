...
* Author        : Amrata M.
*
* Test case     : Verify column widths in dashboard
* 
* Summary 		: Steps:-
...
* 
*******************************************************************************************************************************************************************/
public class EPI_3409750 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_3409750";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_3409750");
		dataSet.put("TL_test_case_description","EPI_3409750:Verify column widths in dashboard.");
		dataSet.put("TL_internal_testCase_ID", "3409750");
		...
		try{			
			if(assertion == false){
				report("f"," assertion is failed while verifying Reference(Content ID)");
			}
			else{

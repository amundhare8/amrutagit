...
* Author        : Amrata M.
*
* Test case     : Verify Search functionality on job details page on Dashboard
* Summary   	: This test case verifies the Search functionality on job details page on Dashboard

***********************************************************************************************************************************************/

public class EPI_979475 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubName = "EpiServer_Sub_979475";
	
	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979475");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_979475: Verify Search functionality on job details page on Dashboard");
				dataSet.put("TL_internal_testCase_ID", "979475");
	}	
	...
	try{
		//GL status
		assertion=Verify.action().verifyElementPresent(locators.exts().GlobalLink_Dashboard_AutomationJob, 10);
		String globalink_Status3=BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_Dashboard_AutomationJob).getText();
	    System.out.println("Globalink Job Name ========>>"+globalink_Status3);
	    
		if(assertion == false){
			report("f"," assertion is failed while verifying  Job Name Search");
		}

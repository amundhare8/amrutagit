...
* Author        : Amrata M.
*
* Test case     : Verify "None" option from "Post Translation Action" field on Auto Submission Tab
* 

* Summary 		: This test case is to Verify "None" option from "Post Translation Action" field on Auto Submission Tab

********************************************************************************************************************************************************************/


public class EPI_4782002 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_4782002");
		dataSet.put("TL_test_case_description","EPI_4782002 : Verify \"None\" option from \"Post Translation Action\" field on Auto Submission Tab.");
		dataSet.put("TL_internal_testCase_ID", "4782002");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//AutoSubmission_PostTranslationAction
				assertion=Verify.action().verifyElementPresent(locators.exts().AutoSubmission_PostTranslationActionSelect("None"), 25);
				if(assertion == false){
					report("f"," assertion is failed while verifying Post Translation Action is saved");
							
		    	}
				BrowserFactory.SystemEngine().findElement(locators.exts().AutoSubmission_PostTranslationActionSelect("None")).click();
				Thread.sleep(2000);

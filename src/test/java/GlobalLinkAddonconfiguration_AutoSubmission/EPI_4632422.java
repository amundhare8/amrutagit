...
* Author        : Amrata M.
*
* Test case     : Verify Auto Submit Current Item-'GlobalLink Translation Jobs' gadget
* 

* Summary 		: This tc is to verify 'Auto Submit Current Item' from GL Gadget
*
*******************************************************************************************************************************************************************/


public class EPI_4632422 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_4632422";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_4632422");
		dataSet.put("TL_test_case_description","EPI_4632422: Verify Auto Submit Current Item-'GlobalLink Translation Jobs' gadget");
		dataSet.put("TL_internal_testCase_ID", "4632422");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//AutoSubmission_PostTranslationAction
				Verify.action().verifyElementPresent(locators.exts().AutoSubmission_PostTranslationActionSelect("Create EPiServer Project For Approval"), 25);
		...
		try{
			...
			if(assertion == false){
				report("f"," assertion is failed while 'Auto Submit current item' option should be enabled");

...
* Author        : Amrata M.
*
* Test case     : Verify "Auto Publish" option from "Post Translation Action" field on Auto Submission Tab
* 

* Summary 		: This test case is to Verify "Auto Publish" option from "Post Translation Action" field on Auto Submission Tab

********************************************************************************************************************************************************************/


public class EPI_4782003 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_4782003");
		dataSet.put("TL_test_case_description","EPI_4782003 : Verify \"Auto Publish\" option from \"Post Translation Action\" field on Auto Submission Tab.");
		dataSet.put("TL_internal_testCase_ID", "4782003");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//AutoSubmission_PostTranslationAction
				assertion=Verify.action().verifyElementPresent(locators.exts().AutoSubmission_PostTranslationActionSelect("Auto Publish"), 25);
				if(assertion == false){
					report("f"," assertion is failed while verifying Post Translation Action is saved");
							
		    	}
				BrowserFactory.SystemEngine().findElement(locators.exts().AutoSubmission_PostTranslationActionSelect("Auto Publish")).click();
				Thread.sleep(2000);
				...
				assertion=common.action().verify_submission_Status(globalink_Jobname, "Published");		
				Thread.sleep(2000);

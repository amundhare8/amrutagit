...
* Preconditions : This test case verifies Site locale languages should be already added.
***********************************************************************************************/

public class EPI_979485 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979485");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979485:Verify add New locale on GlobalLink Config page for 'Local mapping' tab");
				dataSet.put("TL_internal_testCase_ID", "979485");
	}	 

...
* Author        : Amrata M.
*
* Test case     : Verify reviewer is getting notified for submissions of that language pair
* Preconditions : This test case Verify reviewer is getting notified for submissions of that language pair
***********************************************************************************************/
public class EPI_1686613 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1686613");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1686613:Verify reviewer is getting notified for submissions of that language pair");
				dataSet.put("TL_internal_testCase_ID", "1686613");
	}	 

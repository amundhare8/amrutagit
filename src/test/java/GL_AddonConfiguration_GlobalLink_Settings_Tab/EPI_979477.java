...
* Author        : Mayureshwar
*
* Test case     : Verify Project Director details are getting saved on 'GlobalLink Settings' tab
* Test Id       : C979477
...
public class EPI_979477 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979477");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979477:Verify Project Director details are getting saved on 'GlobalLink Settings' tab");
				dataSet.put("TL_internal_testCase_ID", "979477");
	}	

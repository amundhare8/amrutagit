...
* Author        : Amrata M.
*
* Test case     : Verify maxResults value can be configurable by the user
* Test Id       : 3409742
* Summary   	: This test case is to test whether Adapter supports HTTPS Submission Director URL
***********************************************************************************************/
public class EPI_3409742 {

	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubName="auto_submission_3409742";
	int SelectNum;
	int RefNum;
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_3409742");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_3409742:Verify maxResults value can be configurable by the user");
				dataSet.put("TL_internal_testCase_ID", "3409742");
	}	

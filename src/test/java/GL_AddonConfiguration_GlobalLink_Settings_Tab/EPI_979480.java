...
* Author        : Amrata M.
*
* Test case     : Verify functionality of Max number of files per submission configured on GlobalLink Config page for 'GlobalLink settings' tab
* Test Id       : C979480
* Summary   	: This test case verifies the functionality of Max Target count and Max pages count.

EPIVII-305 EPIVII-304 : As per new logic the max page count should not do anything. All pages should be sent in one Scheduler run.
Max target count should work as per old functionality
* Preconditions : Go to Admin-->config-->GlobalLink config-->GlobalLink settings:
				  Configure Max Targets Count:10
***********************************************************************************************/
public class EPI_979480 {

	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubName="auto_submission_979480";
	int SelectNum;
	int RefNum;
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979480");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979480:Verify functionality of Max number of files per submission configured on GlobalLink Config page for 'GlobalLink settings' tab");
				dataSet.put("TL_internal_testCase_ID", "979480");
	}	

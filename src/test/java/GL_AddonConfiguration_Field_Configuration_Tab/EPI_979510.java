...
* Author        : Amrata M.
*
* Test case     : Verify field configuration functionality for 'Standard page' as per settings on GlobalLink Config page for field configuration tab
* 
* Summary   	: This test case verifies the field configuration functionality.

*Precondition 	: Standard page should be created.
**************************************************************************************************************************************************************************************************/
public class EPI_979510 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_979510";

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979510");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979510: Verify field configuration functionality for 'Standard page' as per settings on GlobalLink Config page for field configuration tab");
				
				dataSet.put("TL_internal_testCase_ID", "979510");
	}	

...
* Author        : Amrata M.
*
* Test case     : Verify Synchronize functionality for all available ‘Content Types’ with all supported 
* 				  fields checked as ‘Translatable’ on GlobalLink Config page for field configuration tab
* 
* Summary   	: This test case verifies the field configuration functionality.
* 
***********************************************************************************************/
public class EPI_979508 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_979508";

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979508");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979508:Verify Synchronize functionality for all available ‘Content Types’ with all supported \r\n" + 
						" fields checked as ‘Translatable’ on GlobalLink Config page for field configuration tab\r\n");
				
				dataSet.put("TL_internal_testCase_ID", "979508");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				//Inside Field Config Tab
				common.action().Inside_FieldConfigTab(true, true, true, true, true);

...
* Author        : Amrata M.
*
* Test case     : Verify Property unchecked from field configuration page is not getting populated in target pages
* 
* Summary   	: This test case verifies when Property unchecked from field configuration page is not getting populated in target pages

*Precondition 	: Standard page should be created.
**************************************************************************************************************************************************************************************************/

public class EPI_1686572 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_1686572";

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1686572");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1686572: Verify Property unchecked from field configuration page is not getting populated in target pages");
				
				dataSet.put("TL_internal_testCase_ID", "1686572");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				//Inside Field Config Tab
				common.action().Inside_FieldConfigTab(true, true, true, false, false);

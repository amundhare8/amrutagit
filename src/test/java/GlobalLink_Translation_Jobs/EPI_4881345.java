...
public class EPI_4881345 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_4881345";

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_4881345");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_4881345: Translated xhtml contains mix of source content and translated content USE CASE1");				
				dataSet.put("TL_internal_testCase_ID", "4881345");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				BrowserFactory.SystemEngine().findElement(locators.exts().CMS_edit_Alloy_Content_Mainbody).sendKeys(" - This is MODIFIED content teaser Main Body");				
				Thread.sleep(2000);

...
public class EPI_1470216 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1470216");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1470216:Verify validation messages for mandatory fields on GlobalLink Config page for GlobalLink Settings tab");
				dataSet.put("TL_internal_testCase_ID", "1470216");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				Verify.action().verifyElementPresent(locators.exts().GlobalLink_Password,  5);
				BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_Password).clear();
				BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_Password).sendKeys(EPiServer_Common_Properties_Cred.Password);
				Thread.sleep(1000);

...
* Author        : Proteek
*
* Test case     : Verify cleaning up �All Submissions (active and history)� on GlobalLink Config page for Database Cleanup tab
* 
...
public class EPI_979512 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979512");
		dataSet.put("TL_test_case_description","EPI_979512: Verify cleaning up �All Submissions (active and history)� on GlobalLink Config page for Database Cleanup tab");
		dataSet.put("TL_internal_testCase_ID", "979512");
		...
		try{
			assertion=Verify.action().verifyTextPresent("All submissions deleted Projects:0 GlobalLinkJob itemdatas:0 (History:0)", 10);
	    	if(assertion == false){
				report("f"," assertion is failed while verifying 'All active and history submissions deleted' message should appear in green color and all submissions in active and history should be deleted.");

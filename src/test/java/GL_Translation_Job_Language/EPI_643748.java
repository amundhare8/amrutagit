...
* Author        : Amrata M.
*
* Test case     : Validate Source and target languages fetched from configured PD
* 
...
***********************************************************************************************/
public class EPI_643748 {


	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubName = "EpiServer_Sub_643748";
	String LangName= "fran�ais (France) (fr-FR)";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_643748");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_643748: Validate Source and target languages fetched from configured PD");
				dataSet.put("TL_internal_testCase_ID", "643748");
	}	 

...
/***********************************************************************************************
* Author        : Mayureshwar
* Test case     : Verify select checkbox �Use SSL� is getting save on GlobalLink Config page for Notification tab
* Summary   	: his test case verifies the validation for the field 'Use SSL" checkbox in Notification tab
***********************************************************************************************/
public class EPI_979531 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979531");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979531:Verify select checkbox �Use SSL� is getting save on GlobalLink Config page for Notification tab");
				dataSet.put("TL_internal_testCase_ID", "979531");
	}	

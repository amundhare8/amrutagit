...
/***********************************************************************************************
* Author        : Mayureshwar
* Test case     : Verify entered value for field �SMTP Port� is getting saved on GlobalLink Config page for Notification tab
* Summary   	: This test case verifies the validation for the field 'SMTP Port" in Notification tab
***********************************************************************************************/
public class EPI_979528 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979528");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979528:Verify entered value for field �SMTP Port� is getting saved on GlobalLink Config page for Notification tab");
				dataSet.put("TL_internal_testCase_ID", "979528");
	}	

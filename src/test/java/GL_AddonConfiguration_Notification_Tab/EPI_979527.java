...
* Author        : Mayureshwar
*
* Test case     : Verify entered value for field �SMTP Host� is getting saved on GlobalLink Config page for Notification tab
* Summary   	: This test case verifies the validation for the field 'SMTP Host" in Notification tab
***********************************************************************************************/
public class EPI_979527 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979527");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979527:Verify entered value for field �SMTP Host� is getting saved on GlobalLink Config page for Notification tab");
				dataSet.put("TL_internal_testCase_ID", "979527");
	}	

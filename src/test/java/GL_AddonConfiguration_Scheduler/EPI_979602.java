...
/***********************************************************************************************
* Author        : Mayureshwar
* Test case     : Configuration to allow running background scheduled job
* Summary   	: This test case verifies the configuration to allow background scheduled job
* Precondition  : We can create separate tab in adapter configuration for job, in this tab we can e.g. run only retrieve process,
*                 only send, only cancelled targets, only re-import targets which are ReadyForImport, whatever scheduler configuration client probably needs.
***********************************************************************************************/
public class EPI_979602 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979602");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979602:Configuration to allow running background scheduled job");
				dataSet.put("TL_internal_testCase_ID", "979602");
	}	

...
* Author        : Mayureshwar
*
* Test case     : Verify the functionality of Job Pagination configuration
* Summary   	: This test case verifies the functionality of Job Pagination
***********************************************************************************************/
public class EPI_1010164 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1010164");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1010164:Verify the functionality of Job Pagination configuration");
				dataSet.put("TL_internal_testCase_ID", "1010164");
	}	

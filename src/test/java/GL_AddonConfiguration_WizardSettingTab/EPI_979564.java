...
* Author        : Proteek
*
* Test case     : Verify select checkbox �Include pages Unchanged since last translation� is getting saved on GlobalLink Config page for Wizard settings tab
...
public class EPI_979564 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979564";
	String ProjectName= "EPiServer";
	String globalink_Jobname="";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979564");
		dataSet.put("TL_test_case_description","EPI_979564: Verify select checkbox for �include child nodes� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979564");

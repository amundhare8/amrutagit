...
* Author        : Proteek
*
* Test case     : Verify un-select checkbox for �include child nodes� is getting saved on GlobalLink Config page for Wizard settings tab.
...
public class EPI_979551 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979551";
	String ProjectName= "EPiServer";
	
	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979551");
		dataSet.put("TL_test_case_description","EPI_979551: Verify un-select checkbox for �include child nodes� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979551");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//Inside Wizard Tab
				common.action().Inside_Wizard_Setting_Tab("EPiServer", "English (en)",false, true, true, true, "2", true, false, true,"Auto Publish", true,true);

...
* Author        : Proteek
*
* Test case     : Verify un-select checkbox �Include expired source� is getting saved on GlobalLink Config page for Wizard settings tab
...
public class EPI_979567 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979567";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979567");
		dataSet.put("TL_test_case_description","EPI_979567: Verify un-select checkbox �Include expired source� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979567");
		...
		try{
			assertion=Verify.action().verifyElementNotPresent(locators.exts().Gl_Submit_for_translation_Include_expired_source_content_checkbox_checked, 10);
	    	if(assertion == false){
				report("f"," assertion is failed while verifying Include expired source content Items not checked");

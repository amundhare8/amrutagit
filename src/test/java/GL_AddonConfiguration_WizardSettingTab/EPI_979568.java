...
* Author        : Amrata M.
*
* Test case     : Verify select checkbox �Include expired target� is getting saved on GlobalLink Config page for Wizard settings tab
* Preconditions : This test case verifies the functionality when we select checkbox �Exclude expired target content� is getting saved on GlobalLink Config page for Wizard settings tab
*
*******************************************************************************************************************************************************************/

public class EPI_979568 {

    	Boolean assertion = true;
		LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
		
		String SubName = "EpiServer_Sub_979568";
		String ProjectName= "EPiServer";
		String globalink_Jobname="";
		
		@BeforeMethod
		public void setUp() throws Exception{
			BrowserFactory.SystemEngine().startApplication("EPI_979568");
			dataSet.put("TL_test_case_description","EPI_979568: Verify select checkbox �Include expired target� is getting saved on GlobalLink Config page for Wizard settings tab");
			dataSet.put("TL_internal_testCase_ID", "979568");
			...
			try{
		    	...
		    	if(assertion == false){
					report("f"," assertion is failed while verifying Include expired Target content Items checked");

...
* Author        : Proteek
* 
** Test case    :Verify selected PD Project for field �Default Project� is getting saved on GlobalLink Config page for Wizard settings tab
*
* Summary   	: This test case verifies that the default project can be configured.

***********************************************************************************************************************************************/
public class EPI_979547{
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979547");
		dataSet.put("TL_test_case_description","EPI_979547: Verify selected PD Project for field �Default Project� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979547");

...
* Author        : Proteek
*
* Test case     : Verify un-select checkbox �Include pages Unchanged since last translation� is getting saved on GlobalLink Config page for Wizard settings tab
* Preconditions : This test case verifies the functionality when we check the checkbox "Include pages Unchanged since last translation" configured on GlobalLink 
...
public class EPI_979565 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979565";
	String ProjectName= "EPiServer";
	String globalink_Jobname="";
	
	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979565");
		dataSet.put("TL_test_case_description","EPI_979565: Verify un-select checkbox �Include pages Unchanged since last translation� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979565");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				common.action().Inside_Wizard_Setting_Tab("EPiServer", "English (en)",true, true, true, true, "2", false, false, true,"Auto Publish", true,true);

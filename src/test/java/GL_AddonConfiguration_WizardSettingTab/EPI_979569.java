...
* Author        : Amrata M.
*
* Test case     : Verify un-select checkbox �Include expired target� is getting saved on GlobalLink Config page for Wizard settings tab.
* Preconditions : This test case verifies the functionality when we un-select checkbox �Include expired target� is getting saved on GlobalLink Config page for Wizard settings tab

*******************************************************************************************************************************************************************/

public class EPI_979569 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979569";
	String ProjectName= "EPiServer";
	String globalink_Jobname="";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979569");
		dataSet.put("TL_test_case_description","EPI_979569: Verify select checkbox �Include expired target� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979569");

...
* Author        : Amrata M.
*
* Test case     : Verify select checkbox for �include child nodes� is getting saved on GlobalLink Config page for Wizard settings tab.
* Preconditions : This test case verifies the functionality of select checkbox �include child nodes� configured on GlobalLink Config page for Wizard settings tab.
*
***********************************************************************************************/


public class EPI_979550 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979550";
	String ProjectName= "EPiServer";
	String globalink_Jobname="";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979550");
		dataSet.put("TL_test_case_description","EPI_979550: Verify select checkbox for �include child nodes� is getting saved on GlobalLink Config page for Wizard settings tab");
		dataSet.put("TL_internal_testCase_ID", "979550");

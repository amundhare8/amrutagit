...
* Author        : Amrata M.
* 
** Test case    :Verify selected language for field ‘Default source Locale’ configured on GlobalLink Config page for Wizard settings tab is getting displayed while creating submissions
*
* Summary   	: This test case verifies that the default project can be configured.

***********************************************************************************************************************************************/
public class EPI_979548{
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979548";
	String ProjectName= "EPiServer";
	
	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979548");
		dataSet.put("TL_test_case_description","EPI_979548: Verify selected language for field ‘Default source Locale’ configured on GlobalLink Config page for Wizard settings tab is getting displayed while creating submissions");
		dataSet.put("TL_internal_testCase_ID", "979548");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_WizardTab_Default_Source_Locale_SelectOptions_text).click();
				Thread.sleep(2000);
				
				Verify.action().verifyElementPresent(locators.exts().GlobalLink_WizardTab_Default_Source_Locale_SelectOptions("English (en)"), 5);

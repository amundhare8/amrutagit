...
* Author        : Proteek
*
* Test case     : Verify submissions with content types added to �Non-translatable content types� configured on GlobalLink Config page for Wizard setting tab

* Summary 		: This test case verifies the functionality when we select the "Non-translatable content types" configured on GlobalLink Config page for Wizard 
* 				  settings tab
*
*******************************************************************************************************************************************************************/


public class EPI_979574 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979574";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979574");
		dataSet.put("TL_test_case_description","EPI_979574: Verify submissions with content types added to �Non-translatable content types� configured on GlobalLink Config page for Wizard setting tab");
		dataSet.put("TL_internal_testCase_ID", "979574");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				common.action().select_content_type(true, true, "StandardPage");
				Thread.sleep(2000);
				...
				common.action().create_NewPage("New Page", "Epi_979574", "Standard Page");
				
				BrowserFactory.SystemEngine().findElement(locators.exts().Select_page("Epi_979574")).click();
				Thread.sleep(5000);
		...
		try{
			assertion=Verify.action().verifyElementPresent(locators.exts().CMS_new_job_contentPreview_warning, 10);
	    	if(assertion == false){
				report("f"," assertion is failed while verifying warning icon showed for non translatable standard page ");

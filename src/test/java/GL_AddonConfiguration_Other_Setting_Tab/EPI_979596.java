...
/**=================================================================================================================================================================================
 * @author       : Amrata M.
 * Test case     : Verify ‘Download adapter logs’ of ‘FATAL’ level on GlobalLink Config page for 'Other settings' tab
 * Test Id       : 979596
 * Summary   	 : This test case verifies the functionality to download logs from the UI.
 * Precondition  : Log level has been set to ‘FATAL’
 *
 =================================================================================================================================================================================*/

public class EPI_979596 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979596");
		          //  Test case description here
				dataSet.put("TL_test_case_description","979596 : Verify ‘Download adapter logs’ of ‘FATAL’ level on GlobalLink Config page for 'Other settings' tab");
				dataSet.put("TL_internal_testCase_ID", "979596");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_OtherSetting__Log_Lavel_selectOption("FATAL")).click();//FATAL
				Thread.sleep(3000);		

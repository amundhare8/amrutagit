...
/**=================================================================================================================================================================================
 * @author       : Amrata M.
 * Test case     : Verify ‘Download adapter logs’ of ‘WARN’ level on GlobalLink Config page for 'Other settings' tab
 * Test Id       : 979594
 * Summary   	 : This test case verifies the functionality to download logs from the UI.
 * Precondition  : Log level has been set to ‘WARN’
 *
 =================================================================================================================================================================================*/

public class EPI_979594 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979594");
		          //  Test case description here
				dataSet.put("TL_test_case_description","979594 : Verify ‘Download adapter logs’ of ‘WARN’ level on GlobalLink Config page for 'Other settings' tab");
				dataSet.put("TL_internal_testCase_ID", "979594");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				//Inside tab
				BrowserFactory.SystemEngine().findElement(locators.exts().GlobalLink_OtherSetting__Log_Lavel_selectOption("WARN")).click();//WARN
				Thread.sleep(3000);		
		...
		try{	
	        ...
	        String zipFilePath = BrowserFactory.SystemEngine().properties_downloadSubdir+dateformatter;//e:/Test/MyPics.zip//GlobalLinkLogs.(20210326).zip

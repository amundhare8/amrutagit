...
* Author        : Amrata M.
*
* Test case     : Verify 'None' option for post translation action on configuration tab
* 
* Summary   	: This test case verifies the 'None' option for post translation action on configuration tab
* 
* 
***********************************************************************************************/


public class EPI_643745 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_643745";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_643745");
		dataSet.put("TL_test_case_description","EPI_643745:  Verify 'None' option for post translation action on configuration tab");
		dataSet.put("TL_internal_testCase_ID", "643745");

 ...
 * Author 	  : Amrata M.
 *
 * Test case  : Verify 'Include Expired Target' Configuration option on translation job page
 * 
 * Summary    : This test case verifies the functionality of 'Include Expired Target' Configuration option on translation job page

 Precondition : Expire a target page
 *
 * 
 *******************************************************************************************************************************************************************/
public class EPI_979457 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979457";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979457");
		dataSet.put("TL_test_case_description","EPI_979457: Verify 'Include Expired Target' Configuration option on translation job page");
		dataSet.put("TL_internal_testCase_ID", "979457");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				common.action().Config_ReferencedContentTypesChecks_WithDepthAndActions(true, "2", false, true, true, true, true, "None");
				...
				if ( !BrowserFactory.SystemEngine().findElement(locators.exts().Gl_Submit_Translation_IncludeExpired("Select Expired Target")).isSelected() )
				{
					BrowserFactory.SystemEngine().findElement(locators.exts().Gl_Submit_Translation_IncludeExpired("Select Expired Target")).click();
				}
				Thread.sleep(2000);

...
* Author        : Amrata M.
*
* Test case     : Verify whether reference depth is added on submission window USE CASE 3
* 
...
* 
***********************************************************************************************/
public class EPI_4881279 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_4881279";
	String ProjectName= "EPiServer";
	int SelectNum;
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_4881279");
		dataSet.put("TL_test_case_description","EPI_4881279: Verify whether reference depth is added on submission window USE CASE 3.");
		dataSet.put("TL_internal_testCase_ID", "4881279");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//
				common.action().Submission_Submit_forTranslation("Alloy Plan",SubName,false,false, false, false, false,true, "2", false, false, true, true, true, "None");
		...
		try{
			assertion=Verify.action().verifyElementPresent(locators.exts().ContentPreview_Referenced, 10);				
			Thread.sleep(2000);

...
* Author        : Amrata M.
*
* Test case     : Verify 'Auto publish' option for post translation action on configuration tab
* 
* Summary   	: This test case verifies the 'Auto publish' option for post translation action on configuration tab
* * 
******************************************************************************************************************/
public class EPI_643746 {
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_643746";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_643746");
		dataSet.put("TL_test_case_description","EPI_643746:  Verify 'Auto publish' option for post translation action on configuration tab");
		dataSet.put("TL_internal_testCase_ID", "643746");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//Create Submission			
				common.action().create_basic_submission("Alloy Plan",SubName, true, false, false, false, false, true, "2", false, false, true, true, true, "Auto Publish");
				Thread.sleep(10000);

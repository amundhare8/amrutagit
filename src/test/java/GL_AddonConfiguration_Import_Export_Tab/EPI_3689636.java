...
***************************************************************************************************************************************************************/
public class EPI_3689636 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_3689636";
	String SA="SATEST";
	
	@BeforeMethod
	public void setUp() throws Exception{
		
		BrowserFactory.SystemEngine().startApplication("EPI_3689636");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_3689636: Verify whether the functionality for Simple Address when user selects From Source option from drop down.");
				dataSet.put("TL_internal_testCase_ID", "3689636");
	}	

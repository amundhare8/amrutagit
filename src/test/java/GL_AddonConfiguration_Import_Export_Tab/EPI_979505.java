...
***********************************************************************************************/
public class EPI_979505 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String PageName = "Epi_979505";
	String actualTooltip="";
	@BeforeMethod
	public void setUp() throws Exception{
		
		BrowserFactory.SystemEngine().startApplication("EPI_979505");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_979505: Verify status for imported submissions when ‘Not Ready (Draft)’ value configured for field ‘Default status on importing’ on GlobalLink Config page.");
				dataSet.put("TL_internal_testCase_ID", "979505");
	}	

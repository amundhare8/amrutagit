...
* Author        : Amrata M.
*
* Test case     : Verify EPiServer notification for successful job
* 
* Summary 		: This test case verifies the EPiServer notification for successful job
* 
*******************************************************************************************************************************************************************/


public class EPI_979449 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979449";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979449");
		dataSet.put("TL_test_case_description","EPI_979449:Verify EPiServer notification for successful job");
		dataSet.put("TL_internal_testCase_ID", "979449");

...
* Author        : Amrata M.
*
* Test case     : Verify entered value and time variable for field �Scheduled job interval� is getting save on GlobalLink Scheduler page for settings tab.
* 
* Summary 		: This test case verify value for scheduler is getting saved successfully

*
*******************************************************************************************************************************************************************/

public class EPI_979731 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979731");
		dataSet.put("TL_test_case_description","EPI_979731: Verify entered value and time variable for field �Scheduled job interval� is getting save on GlobalLink Scheduler page for settings tab.");
		dataSet.put("TL_internal_testCase_ID", "979731");

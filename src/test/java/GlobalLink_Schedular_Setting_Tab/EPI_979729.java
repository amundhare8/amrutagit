...
* Author        : Amrata M.
*
* Test case     : Verify select checkbox �Active� is getting save on GlobalLink Scheduler page for settings tab
* 
* Summary 		: This test case verifies the checkbox �Active� is getting save on GlobalLink Scheduler page for settings tab

*
*******************************************************************************************************************************************************************/

public class EPI_979729 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979729");
		dataSet.put("TL_test_case_description","EPI_979729: Verify select checkbox �Active� is getting save on GlobalLink Scheduler page for settings tab.");
		dataSet.put("TL_internal_testCase_ID", "979729");
		...
		public void assertion() throws Exception{
			try{
				assertion=Verify.action().verifyElementIschecked(locators.exts().GlobalLink_Schedular_Active, 10);
		    	if(assertion == false){
					report("f"," assertion is failed while verifying Active not checked");

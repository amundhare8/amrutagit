...
* Author        : Amrata M.
*
* Test case     : Verify ‘Start Manually’ for scheduler on GlobalLink Scheduler page for settings tab.
* 
*******************************************************************************************************************************************************************/

public class EPI_979733 {
	...
	public void setUp() throws Exception{
		...
		BrowserFactory.SystemEngine().startApplication("EPI_979733");
		dataSet.put("TL_test_case_description","EPI_979733: Verify ‘Start Manually’ for scheduler on GlobalLink Scheduler page for settings tab.");
		dataSet.put("TL_internal_testCase_ID", "979733");
	}	

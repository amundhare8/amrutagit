...
* Author        : Amrata M.
*
* Test case     : Verify cleaning up �All active submissions only (keep history)� on GlobalLink Config page for Database Cleanup tab
* 
...
public class EPI_979513 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();

	String SubName = "EpiServer_Sub_979513";
	String ProjectName= "EPiServer";
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979513");
		dataSet.put("TL_test_case_description","EPI_979513: Verify cleaning up �All active submissions only (keep history)� on GlobalLink Config page for Database Cleanup tab");
		dataSet.put("TL_internal_testCase_ID", "979513");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//Create Submission
				common.action().create_basic_submission("Serach",SubName, true, false, false, false, false, true, "2", false, false, false, true, true, "None");
				Thread.sleep(5000);

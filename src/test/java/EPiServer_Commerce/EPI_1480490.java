...
* Author        : Mayureshwar
* Test Id       : 1480490
* Test case     : Verify Dashboard filter menus
...
public class EPI_1480490 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1480490");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1480490:	Verify Dashboard filter menus");
				dataSet.put("TL_internal_testCase_ID", "1480490");
	}	
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{
				...
				assertion=Verify.action().verifyElementPresent(locators.exts().GlobalLink_Dashboard_verify_Published_status, 10);
				if(assertion == false){

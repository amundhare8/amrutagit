...
* Author        : Amrata M.
*
* Test case     : Verify create new 'GlobalLink Translation Job' with Blocks
* Preconditions : This test case verifies the creation of new "GlobalLink Translation Job" with Pages, Blocks and Products
* 
********************************************************************************************************************************/
public class EPI_980608 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_980608";
		
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_980608");
		dataSet.put("TL_test_case_description","EPI_980608: Verify create new 'GlobalLink Translation Job' with Blocks");
		dataSet.put("TL_internal_testCase_ID", "980608");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				//Create Submission
				common.action().create_basic_submission_Block("Alloy Plan",SubName, true, false, false, false, false, false, "2", false, false, true, true, true, "Auto Publish");
				Thread.sleep(5000);

...
public class EPI_1469987 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1469987");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_1469987: Verify Submission listing on Dashboard");
				dataSet.put("TL_internal_testCase_ID", "1469987");
	}	

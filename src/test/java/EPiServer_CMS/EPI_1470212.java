...
* Test Id       : 1470212
* Summary   	: ThThis test case will cover the scenario when valid information is given to all the parameters below it will verify that these changes can be saved.
***********************************************************************************************/
public class EPI_1470212 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_1470212");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_1470212:Verify Project Director details are getting saved on 'GlobalLink Settings' tab with confirmation message");
				dataSet.put("TL_internal_testCase_ID", "1470212");
	}	
		...
		try{
			...
			if(assertion == false){
				report("f"," assertion is failed while verifying GlobalLink Settings");
			}else{

...
* Author        : Amrata M.
*
* Test case     : Verify translation jobs are getting removed to trash upon successful submit to PD
* Preconditions : This test case verifies the translation jobs are getting removed to trash upon successful submit to PD.
* 
***********************************************************************************************/
public class EPI_979448 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979448");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_979448: Verify the confirmation message for deleting translation job");
				dataSet.put("TL_internal_testCase_ID", "979448");
	}	

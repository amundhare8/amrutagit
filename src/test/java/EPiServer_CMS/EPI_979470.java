...
public class EPI_979470 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979470");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_979470:	Verify Dashboard filter menus");
				dataSet.put("TL_internal_testCase_ID", "979470");
	}	

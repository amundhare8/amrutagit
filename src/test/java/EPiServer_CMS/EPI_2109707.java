...
* Author        : Amrata M.
*
* Test case     : This test verifies whether Empty Trash task should not take longer time
* Preconditions : Create few GL translation Jobs and move them to Trash folder
* 
***********************************************************************************************/

public class EPI_2109707 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_2109707");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_2109707: This test verifies whether Empty Trash task should not take longer time");
				dataSet.put("TL_internal_testCase_ID", "2109707");
	}	
	public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
		try{
           ...
           assertion=Verify.action().verifyElementPresent(locators.exts().GL_Global_JobDelete_MoveToTrashButton, 10);	
			...
			assertion=Verify.action().verifyElementPresent(locators.exts().CMS_edit_Move_to_Trash_EmptyTrash_Yes, 10);
			 if(assertion == false){
					report("f"," assertion is failed while verifying EmptyTrash");
			}

...
public class EPI_643736 {
	...
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_643736");
		// Write you Test case description here
				dataSet.put("TL_test_case_description","EPI_643736:Verify remove 'GlobalLink Translation Jobs' gadget");
				dataSet.put("TL_internal_testCase_ID", "643736");
	}	

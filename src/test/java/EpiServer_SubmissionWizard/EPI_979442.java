...
* Author        : Amrata M.
*
* Test case     : Verify selected contents on submission wizard
* 
* Summary 		: This test case verifies the selected contents on submission wizard

*******************************************************************************************************************************************************************/

public class EPI_979442 {

	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979442";
	
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979442");
		dataSet.put("TL_test_case_description","EPI_979442:Verify selected contents on submission wizard");
		dataSet.put("TL_internal_testCase_ID", "979442");

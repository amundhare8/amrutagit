...
* Author        : Amrata M.
*
* Test case     : Verify details of job entered during job creation on Submission wizard
* Summary   	: This test case verifies the details of Job entered during job creation on Submission wizard

************************************************************************************************************************************************/

public class EPI_979466 {


	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	String SubName = "EpiServer_Sub_979466";
	
	@BeforeMethod	
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979466");
		          //  Test case description here
				dataSet.put("TL_test_case_description","EPI_979466:  Verify details of job entered during job creation on Submission wizard");
				dataSet.put("TL_internal_testCase_ID", "979466");
	}	

...
* Author        : Amrata M.
*
* Test case     : Verify selected configuration options from 'Content Selection Settings' tab on Submission Wizard
* 
* Summary 		: This test case verifies selected configuration options from 'Content Selection Settings' tab on Submission Wizard

*******************************************************************************************************************************************************************/

public class EPI_979441 {
	
	Boolean assertion = true;
	LinkedHashMap<String, String> dataSet = new LinkedHashMap<String, String>();
	
	String SubName = "EpiServer_Sub_979441";
	
	
	@BeforeMethod
	public void setUp() throws Exception{
		BrowserFactory.SystemEngine().startApplication("EPI_979441");
		dataSet.put("TL_test_case_description","EPI_979441:Verify selected configuration options from 'Content Selection Settings' tab on Submission Wizard");
		dataSet.put("TL_internal_testCase_ID", "979441");
		...
		public void testcase(LinkedHashMap<String, String> dataSet) throws Exception{
			try{	
				...
				common.action().Selectpage_ContentTab("Search", SubName);	
